...
{
    /**
     * Проверяет, что адаптер транзакций для менеджера соединений всегда сообщает о поддержке транзакционного режима.
     */
    #[Test]
    ...
    /**
     * Проверяет, что адаптер корректно открывает и откатывает транзакцию через менеджер соединений.
     */
    #[Test]
