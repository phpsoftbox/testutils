...
final class DatabaseReloaderTest extends TestCase
{
    ...
    /**
     * Проверяет, что при отсутствии файла дампа reloader инициирует его создание перед восстановлением.
     */
    #[Test]
    ...
    /**
     * Проверяет, что при существующем файле дампа повторное создание дампа не выполняется.
     */
    #[Test]
    ...
    /**
     * Проверяет, что временный файл дампа удаляется, если каталог для постоянного хранения не задан.
     */
    #[Test]
    ...
    /**
     * Проверяет, что метод withModeAndConnections создает новый экземпляр reloader с измененными параметрами.
     */
    #[Test]
