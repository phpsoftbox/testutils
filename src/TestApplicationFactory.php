...
final readonly class TestApplicationFactory
{
    ...
    public function __construct(
        ...
        private EnvironmentEnumInterface $environment,
    ...
    {
        return (string) $this->environment->value;
    }
    ...
    public function createConfig(bool $readOnly = false): Config
    {
        ...
        $environment    = (string) $this->environment->value;
        $localConfigDir = $this->localConfigPath ?? ($this->basePath . '/local/config/' . $environment . '/app');
        ...
        $factory = new ConfigFactory(
            ...
            providers: [
                ...
                new PhpFileDataProvider($configDir . '/' . $environment . '/*.php'),
